                    ...
                    customProps: {
                        background: {
                            light: {
                                'bg-app-bar'   : '#FFFFFF',
                                'bg-card'      : '#FFFFFF',
                                'bg-default'   : colors.trueGray[100],
                                'bg-dialog'    : '#FFFFFF',
                                'bg-hover'     : chroma(colors.trueGray[400]).alpha(0.12).css(),
                                'bg-status-bar': colors.trueGray[300]
                            },
                            dark : {
                                'bg-app-bar'   : colors.trueGray[900],
                                'bg-card'      : colors.trueGray[800],
                                'bg-default'   : colors.trueGray[900],
                                'bg-dialog'    : colors.trueGray[800],
                                'bg-hover'     : 'rgba(255, 255, 255, 0.05)',
                                'bg-status-bar': colors.trueGray[900]
                            }
                        },
                        foreground: {
                            light: {
                                'text-default'  : colors.trueGray[800],
                                'text-secondary': colors.trueGray[500],
                                'text-hint'     : colors.trueGray[400],
                                'text-disabled' : colors.trueGray[400],
                                'border'        : colors.trueGray[200],
                                'divider'       : colors.trueGray[200],
                                'icon'          : colors.trueGray[500],
                                'mat-icon'      : colors.trueGray[500]
                            },
                            dark : {
                                'text-default'  : '#FFFFFF',
                                'text-secondary': colors.trueGray[400],
                                'text-hint'     : colors.trueGray[500],
                                'text-disabled' : colors.trueGray[600],
                                'border'        : chroma(colors.trueGray[100]).alpha(0.12).css(),
                                'divider'       : chroma(colors.trueGray[100]).alpha(0.12).css(),
                                'icon'          : colors.trueGray[400],
                                'mat-icon'      : colors.trueGray[400]
                            }
                        }
                    },
